...
const Gallery = () => {
  return (
    <MaxWidthWrapper className="flex flex-row-reverse justify-between items-center my-20 gap-28">
      <div className="flex-grow flex flex-col justify-start items-center gap-5">
        ...
        <p className="w-full text-center text-zinc-600 font-light font-['Optima nova LT Pro'] capitalize leading-7 tracking-wide font-body">

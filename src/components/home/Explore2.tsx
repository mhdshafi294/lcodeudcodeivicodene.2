      ...
      <div className="max-w-full flex flex-col-reverse gap-5 sm:gap-0 sm:flex-row justify-between items-center mx-auto sm:w-[80%] md:max-w-screen-xl my-4">
        <div className="flex justify-start items-center md:w-3/5">
          <div className=" flex flex-col justify-center items-center sm:items-start gap-4">
            ...
            <p className="text-zinc-700 font-light text-[18px] tracking-wide font-body leading-7 text-center sm:text-left w-10/12 mb-7 mt-5">
        ...
        <div className="flex justify-center items-center w-1/2">
          <img
            src={explore22}
            alt="white gold ring"
            className="h-[150px] md:h-[472px] object-cover"
          />
        </div>
      </div>
    </div>
